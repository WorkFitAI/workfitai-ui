...
export const { clearSelectedApplication, clearError } =
  applicationSlice.actions;
export default applicationSlice.reducer;

// Selectors
export const selectApplications = (state: RootState): Application[] =>
  state.application.applications;
export const selectSelectedApplication = (
  state: RootState
): Application | null => state.application.selectedApplication;
export const selectApplicationMeta = (state: RootState): PaginationMeta =>
  state.application.meta;
export const selectApplicationLoading = (state: RootState): boolean =>
  state.application.loading;
export const selectApplicationError = (state: RootState): string | null =>
  state.application.error;
export const selectDashboardStats = (state: RootState): DashboardStats | null =>
  state.application.dashboardStats;
