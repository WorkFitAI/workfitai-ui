...
export default function Modal({ modalToggle, handleModal }: ModalProps) {
  const modalStyle: CSSProperties | undefined = modalToggle
    ? { paddingRight: 17, display: "block" }
    : undefined;

  return (
    <div className={`modal fade ${modalToggle ? "show" : ""}`} style={modalStyle}>
