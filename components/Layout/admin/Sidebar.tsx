    ...
    <div className={`nav ${isToggled ? "close-nav" : ""}`}>
      ...
      <nav className="nav-main-menu">
        <ul className="main-menu">
          ...
          <li>
            <Link className={isActive("/login") ? "dashboard2 active" : "dashboard2"} href="/login">
      ...
      <div className="box-profile-completed text-center mb-30">
        ...
        <p className="font-xs color-text-mutted">
          Please add detailed information to your profile. This will help you develop your career
          more quickly.
        </p>
      </div>
