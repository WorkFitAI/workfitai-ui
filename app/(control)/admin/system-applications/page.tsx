...
import type { Application, PaginationMeta } from '@/types/application/application';
      ...
      <div className="box-heading">
        ...
        <div className="box-breadcrumb">
          <div className="breadcrumbs">
            <ul>
              <li><a className="icon-home" href="/admin">Admin</a></li>
              <li><span>System Applications</span></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="alert alert-warning">
            ...
            <strong>Admin View:</strong> You are viewing all applications across all companies.
          </div>

          <div className="d-flex justify-content-between mb-3">
            <h5>Platform Applications</h5>
            <span className="text-muted">
              {meta.totalItems} total applications
            </span>
          </div>
