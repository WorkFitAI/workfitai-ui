...
import VacancyChart from "@/components/elements/control/VacancyChart";
import BrandSlider from "@/components/sliders/control/BrandSlider";
import { ReactNode } from "react";

const metrics = [
  { label: "Interview Schedules", value: "1,568", trend: "+25%", direction: "up" as const, icon: "/assets/imgs/page/dashboard/computer.svg" },
  { label: "Applied Jobs", value: "284", trend: "+5%", direction: "up" as const, icon: "/assets/imgs/page/dashboard/bank.svg" },
  { label: "Task Bids Won", value: "136", trend: "+12%", direction: "up" as const, icon: "/assets/imgs/page/dashboard/lamp.svg" },
  { label: "Application Sent", value: "985", trend: "+5%", direction: "up" as const, icon: "/assets/imgs/page/dashboard/headphone.svg" },
];
                    ...
                    <div className="card-style-4 hover-up">
                      <div className="d-flex">
                        ...
                        <div className="card-title">
                          ...
                          <img src="/assets/control/imgs/page/dashboard/star.svg" alt="rating" />
                          <img src="/assets/control/imgs/page/dashboard/star.svg" alt="rating" />
                          <img src="/assets/control/imgs/page/dashboard/star.svg" alt="rating" />
                          <img src="/assets/control/imgs/page/dashboard/star-none.svg" alt="rating" />
                          <img src="/assets/control/imgs/page/dashboard/star-none.svg" alt="rating" />
